					...
					<div class="appContainer">
						...
						<div class="searchContainer">
							...
							<div class="inputContainer">
								<span class="zipContainer">
									<input type="number" placeholder="ZIP CODE" maxLength="5" v-model="zip" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
									<div v-if="zipError" class="error">{{config.zipErrorMsg}}</div>
								</span>
